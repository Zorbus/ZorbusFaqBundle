...
namespace Zorbus\FaqBundle\Model;
...
class BlockFaqConfig extends BlockConfig
{
    ...
    public function getFormMapper()
    {
        return $this->formMapper
                        ->add('faq', 'entity', array(
                            'class' => 'Zorbus\\FaqBundle\\Entity\\Faq',
    ...
    public function getBlockEntity(array $data, BlockEntity $block = null)
    {
        ...
        $block->setParameters(json_encode(array('faq_id' => $data['faq']->getId())));
